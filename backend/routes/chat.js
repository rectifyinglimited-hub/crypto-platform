...
const TOPIC_BRIEFINGS = {
  vip: [
    ...
    "",
    "How VIP works",
    "• Lounge VIP is granted by the desk — priority Live Chat, personal manager, faster payout review.",
  ...
  loan: [
    ...
    "   • Term in days",
    "   • Purpose of the loan",
    "4. Interest is shown on the Loan calculator before you submit. Every request is desk-reviewed.",
    "",
  ...
  withdraw: [
    ...
    "",
    "1. Add a crypto wallet or bank card in Assets and wait for desk approval.",
