              ...
              {canSubmit && (
                <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        {DOC_TYPES.map((d) => {
                          ...
                          return (
                            <button
                              ...
                              className={`inline-flex min-h-10 flex-1 items-center justify-center gap-1.5 rounded-xl border px-3 py-2 text-[11px] font-semibold transition sm:flex-none sm:px-4 ${
                                active
                  ...
                  <p className="text-center text-[10px] text-slate-500">
                    Your document and selfie are stored securely. equiti never
