...
export function ReferralSection({ user, onToast }) {
  ...
  return (
    <div className="space-y-4">
      {referredBy ? (
        <Card className="relative overflow-hidden border-[#39FF14]/30 bg-[#39FF14]/5">
          <div className="mb-2 flex items-center gap-2 text-[11px] font-bold uppercase tracking-[0.18em] text-[#39FF14]">
          ...
          <div className="flex flex-wrap items-start justify-between gap-4">
            ...
            <div className="grid grid-cols-2 gap-2 text-center sm:grid-cols-3">
              <div className="rounded-xl border border-white/10 bg-black/30 px-3 py-2">
                ...
                <div className="mt-1 text-sm font-bold text-[#39FF14]">
      ...
      <Card className="relative overflow-hidden">
        <div className="pointer-events-none absolute inset-0 bg-gradient-to-br from-[#39FF14]/10 via-transparent to-cyan-500/10" />
        <div className="relative">
          <div className="mb-1 flex items-center gap-2 text-[11px] font-bold uppercase tracking-[0.18em] text-[#39FF14]">
                ...
                <div className="flex h-[148px] w-full items-end justify-center">
                  <div
                    className={`w-full max-w-[52px] rounded-t-lg ${
                      nearYou
                        ? "bg-gradient-to-t from-[#39FF14] to-cyan-300"
